...
function renderPlants(plantArray) {
  ...
  plantArray.forEach((plant) => {
    ...
    plantCard.innerHTML = `
      ...
      <p><strong><i class="fas fa-thermometer-low"></i> Temperatura ideale min:</strong> ${plant.tempMin}°C</p>
      <p><strong><i class="fas fa-thermometer-high"></i> Temperatura ideale max:</strong> ${plant.tempMax}°C</p>
