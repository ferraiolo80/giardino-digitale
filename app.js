    ...
    try {
        ...
        if (user) {
            ...
            if (doc.exists) {
                ...
                myGarden = JSON.parse(localStorage.getItem("myGarden")) || []; // Carica da localStorage
            }
        } else {
        ...
        myGarden = JSON.parse(localStorage.getItem("myGarden")) || []; // In caso di errore, prova a caricare da localStorage
    }
    console.log("loadMyGardenFromFirebase - myGarden AFTER:", JSON.stringify(myGarden));
    renderMyGarden(myGarden); // Chiama renderMyGarden SOLO qui
...
async function removeFromMyGarden(plantIdToRemove) {
    ...
    try {
        ...
        console.log("removeFromMyGarden - myGarden AFTER filter:", JSON.stringify(myGarden));
        localStorage.setItem("myGarden", JSON.stringify(myGarden));
...
<button class\="remove\-button" data\-plant\-id\="</span>{plantData.id}">Rimuovi</button>
    ...
    removeButton.addEventListener('click', () => {
        ...
        console.log("Rimuovi button clicked. plantIdToRemove:", plantIdToRemove);
    ...
    updateButton.addEventListener('click', () => {
        ...
        console.log("Aggiorna button clicked. plantNameToUpdate:", plantNameToUpdate);
...
function updatePlant(plantName) {
    console.log("updatePlant CALLED. plantName:", plantName);
